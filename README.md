<h1 align="center">Hi, I'm Sikandar Zulqarnain</h1>
<h3 align="center">Full-Stack Developer | CS Student | Future Data Analyst</h3>

<p align="center">
  <a href="https://github.com/withzaku">
    <img src="https://komarev.com/ghpvc/?username=withzaku&label=Profile%20views&color=0e75b6&style=flat" alt="withzaku" />
  </a>
</p>
...
**Database & Services:**  
`MongoDB` `PostgreSQL (Railway)` `Firebase`

**Tools & Platforms:**  
`Git` `GitHub` `Vercel` `Linux` `VS Code`

**Python Tools:**  
`Pandas` `NumPy` `Selenium` `Tkinter`
...
> I turn complex ideas into real-world working systems 🚀
